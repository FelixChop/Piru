...
const i18nResources = {
  en: {
    translation: {
      ...
      unlock_question: 'Unlock for {{count}} cookie',
      unlock_question_plural: 'Unlock for {{count}} cookies',
      play: 'Play',
  ...
  fr: {
    translation: {
      ...
      quiz: 'QCM',
      quiz_reverse: 'QCM inversé',
      unlock_for_cookie: 'Débloquer : 1 cookie',
      not_enough_cookies: 'Pas assez de cookies',
      cookie_count: '{{count}} cookie',
      cookie_count_plural: '{{count}} cookies',
      unlock_question: 'Débloquer pour {{count}} cookie',
      unlock_question_plural: 'Débloquer pour {{count}} cookies',
      play: 'Jouer',
  ...
  es: {
    translation: {
      ...
      confirm_delete_account: '¿Seguro que quieres eliminar tu cuenta? Esta acción no se puede deshacer.',
        ...
        show_word: 'Mostrar palabra',
        delete_known: 'Demasiado fácil',
        i_know: 'La conozco',
      ...
      cookie_count_plural: '{{count}} galletas',
        unlock_question: 'Desbloquear por {{count}} galleta',
        unlock_question_plural: 'Desbloquear por {{count}} galletas',
      play: 'Jugar',
  ...
  it: {
    translation: {
      ...
      show_word: 'Mostra parola',
      delete_known: 'Troppo facile',
      i_know: 'La conosco',
      ...
      unlock_question: 'Sblocca per {{count}} biscotto',
      unlock_question_plural: 'Sblocca per {{count}} biscotti',
      play: 'Gioca',
  ...
  de: {
    translation: {
      ...
      unlock_question: 'Freischalten für {{count}} Keks',
      unlock_question_plural: 'Freischalten für {{count}} Kekse',
      play: 'Spielen',
