...
const i18nResources = {
  en: {
    translation: {
      ...
      search_movies_series: 'Search Films or Series',
  ...
  fr: {
    translation: {
      ...
      search_movies_series: 'Rechercher des films ou séries',
      search_lyrics: 'Rechercher des paroles',
      search: 'Rechercher',
  ...
  es: {
    translation: {
      ...
      search_movies_series: 'Buscar películas o series',
  ...
  it: {
    translation: {
      ...
      search_movies_series: 'Cerca film o serie',
      search_lyrics: 'Cerca testi',
      search: 'Cerca',
  ...
  de: {
    translation: {
      ...
      search_movies_series: 'Filme oder Serien suchen',
      search_lyrics: 'Songtexte suchen',
      search: 'Suchen',
